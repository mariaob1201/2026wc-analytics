...
_Model trained on pre-tournament data only (results to 2026-06-10 + FIFA squad prior). Backtest compares those out-of-sample forecasts to the actual scorelines; forecasts cover the next slate. Compiled 2026-07-06._
...
| 2026-07-05 | Brazil v Norway | 2.1-1.1 | 1-1 | 59%/21%/20% | **0-2** | — |
...
|---|---|---|---|---|---|---|
| 2026-07-06 | Portugal v Spain | 1.6-1.3 | 1-1 | 44%/25%/32% | 53% | +0.14/+0.15 |
...
| 2026-07-06 | Switzerland v Colombia | 1.1-1.6 | 1-1 | 27%/25%/49% | 51% | +0.13/+0.09 |
| 2026-07-09 | France v Morocco | 1.7-0.9 | 1-0 | 55%/24%/21% | 47% | +0.18/+0.11 |
