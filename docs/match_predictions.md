...
_Model trained on pre-tournament data only (results to 2026-06-10 + FIFA squad prior). Backtest compares those out-of-sample forecasts to the actual scorelines; forecasts cover the next slate. Compiled 2026-07-09._

## Accuracy so far (out-of-sample)

- **Matches scored:** 96
- **Outcome hit-rate:** 65% (predicted W/D/L matched actual)
- **Mean probability on the actual outcome:** 0.45 · **Brier score:** 0.513 (lower is better)
- **Total-goals mean abs error:** 1.43 goals/match
...
|---|---|---|---|---|---|---|
| 2026-07-09 | France v Morocco | 1.7-0.9 | 1-0 | 56%/24%/20% | 48% | +0.18/+0.12 |
...
| 2026-07-11 | Argentina v Switzerland | 2.0-1.1 | 1-1 | 59%/21%/20% | 60% | +0.17/+0.12 |
