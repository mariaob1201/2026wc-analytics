...
_Model trained on pre-tournament data only (results to 2026-06-10 + FIFA squad prior). Backtest compares those out-of-sample forecasts to the actual scorelines; forecasts cover the next slate. Compiled 2026-07-04._

## Accuracy so far (out-of-sample)

- **Matches scored:** 88
- **Outcome hit-rate:** 65% (predicted W/D/L matched actual)
- **Mean probability on the actual outcome:** 0.45 · **Brier score:** 0.508 (lower is better)
...
|---|---|---|---|---|---|---|
| 2026-07-04 | Canada v Morocco | 1.1-1.2 | 1-1 | 34%/28%/38% | 39% | +0.11/+0.08 |
| 2026-07-04 | Paraguay v France | 0.6-1.8 | 0-1 | 13%/22%/66% | 45% | -0.03/+0.18 |
| 2026-07-05 | Brazil v Norway | 2.4-1.1 | 2-1 | 65%/18%/17% | 68% | +0.16/+0.05 |
| 2026-07-05 | Mexico v England | 1.5-1.6 | 1-1 | 35%/23%/42% | 60% | +0.13/+0.09 |
| 2026-07-06 | Argentina v Egypt | 2.1-0.7 | 2-0 | 71%/19%/11% | 52% | +0.18/+0.04 |
| 2026-07-06 | Portugal v Spain | 1.5-1.3 | 1-1 | 44%/25%/32% | 53% | +0.14/+0.15 |
| 2026-07-06 | United States v Belgium | 1.3-2.1 | 1-2 | 23%/20%/56% | 66% | +0.05/+0.18 |
| 2026-07-06 | Switzerland v Colombia | 1.1-1.6 | 1-1 | 27%/25%/49% | 51% | +0.13/+0.08 |
