...
_A simple **Elo** model, conditioned on the **94 matches played so far** and the real 2026 bracket. Updated 2026-07-07._
...
|--:|---|---|---|---|---|---|
| 1 | Spain | 91% | 50% | 30% | 21% | **15%** |
| 2 | France | 90% | 47% | 26% | 17% | **13%** |
| 3 | Argentina | 89% | 55% | 27% | 17% | **12%** |
| 4 | Belgium | 73% | 42% | 26% | 16% | **7%** |
| 5 | England | 77% | 43% | 24% | 10% | **6%** |
| 6 | Colombia | 78% | 44% | 25% | 9% | **6%** |
| 7 | Portugal | 81% | 38% | 16% | 9% | **6%** |
| 8 | Brazil | 74% | 43% | 22% | 8% | **5%** |
| 9 | Morocco | 74% | 41% | 21% | 8% | **4%** |
| 10 | Switzerland | 68% | 37% | 21% | 12% | **4%** |
| 11 | Mexico | 66% | 37% | 19% | 11% | **4%** |
| 12 | Netherlands | 63% | 33% | 16% | 10% | **3%** |
...
_Each WC match was predicted from Elo as it stood **before** that game (then the rating updated). Running accuracy: **62%** on 94 matches. Full log: `data/processed/winners_track.csv`._
...
_Showing the latest 12 of 94. Elo hit-rate vs a coin-flip baseline is the honest scoreboard for these picks._
