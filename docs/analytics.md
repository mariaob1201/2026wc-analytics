...
_Run after each matchday to track model calibration and read the next slate. Charts in `artifacts/`. Compiled 2026-07-05._
...
**Tracking metrics (90 matches):** outcome hit-rate 66% · total-goals MAE 1.40. Re-run to update as results come in.
...
| Brazil v Norway | red-hot (+0.16) | rising (+0.05) | **Brazil** |
...
| France v Morocco | red-hot (+0.17) | rising (+0.11) | **France** |
