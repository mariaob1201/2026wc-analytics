...
**Tracking metrics (48 matches):** outcome hit-rate 62% · total-goals MAE 1.55. Re-run to update as results come in.
...
| Japan v Sweden | rising (+0.11) | dipping (-0.08) | **Japan** |
...
| Algeria v Austria | steady (+0.01) | rising (+0.08) | **Austria** |
