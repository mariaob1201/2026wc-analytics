...
_A simple Bayesian model of the **signed goal difference** (home - away): `goal_diff ~ Normal(mu, sigma)`, `mu = home_adv + strength[home] - strength[away]`, with a player-informed prior on strength. Refit daily on the latest results. Fit on **656 matches** through 2026-07-13._
...
_Updated 2026-07-13 by the daily tracker._