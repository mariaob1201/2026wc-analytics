...
_A simple Bayesian model of the **signed goal difference** (home - away): `goal_diff ~ Normal(mu, sigma)`, `mu = home_adv + strength[home] - strength[away]`, with a player-informed prior on strength. Refit daily on the latest results. Fit on **656 matches** through 2026-07-11._
...
|---|---|--:|--:|--:|--:|
| 2026-07-11 | Norway v England | -0.58 | 26% | 22% | 53% |
| 2026-07-11 | Argentina v Switzerland | +0.55 | 51% | 22% | 27% |
...
_Updated 2026-07-11 by the daily tracker._